        ...
        <div class="container-fluid">
                ...
                <div class="col-md-12 column">
                    <table class="table table-hover table-condensed table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/wxsell/seller/product/index?productId=${productInfo.productId}">详情</a>
                            </td>
                            <td>
                                <#if productInfo.getProductStatusEnum().message=="在架">
                                    <a href="/wxsell/seller/product/off_sale?productId=${productInfo.productId}">下架</a>
                                <#else >
                                    <a href="/wxsell/seller/product/on_sale?productId=${productInfo.productId}">在架</a>
                                </#if>
                            </td>
                        </tr>
                        </#list>
            ...
            <#--分页-->
                <div class="col-md-12 column">
                    ...
                    <#list 0..productInfoPage.getTotalPages() as index>
