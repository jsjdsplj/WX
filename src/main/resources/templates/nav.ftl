<nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
    <ul class="nav sidebar-nav">
        ...
        <li>
            <a href="/wxsell/seller/order/list"><i class="fa fa-fw fa-list-alt"></i> 订单</a>
        </li>
        <li class="dropdown open">
            ...
            <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="/wxsell/seller/product/list">列表</a></li>
                <li><a href="/wxsell/seller/product/index">新增</a></li>
            </ul>
        </li>
        <li class="dropdown open">
            ...
            <ul class="dropdown-menu" role="menu">
                <li class="dropdown-header">操作</li>
                <li><a href="/wxsell/seller/category/list">列表</a></li>
                <li><a href="/wxsell/seller/category/index">新增</a></li>
            </ul>
        </li>
